...
class RPLidar(object):
    ...
    def get_one_packet(self, scan_type='normal'):
        '''Gets one data point from the LiDAR. This function assumes the scan
        type is normal, and is thus a simplified version of iter_measures().
